...
\resumeItemListStart
\resumeItem{Led effort to take global path planning algorithm from research paper pseudo code, to Python prototype, to C++ and ROS implementation on a \href{https://clearpathrobotics.com/husky-unmanned-ground-vehicle-robot/}{Clearpath Husky UGV}; conducted testing in simulation with \href{https://gazebosim.org/home}{Gazebo} and on the live platform; successfully avoided obstacles while applying desired safety factors}
\resumeItem{Developed a Python interface to translate existing drone messaging protocols to \href{https://microsoft.github.io/AirSim/}{AirSim} API calls for seamless transition to new simulation setup}
...
\resumeItemListStart
\resumeItem{Supported creation of Model-in-Loop framework for production controls software components; tested \textasciitilde 50 requirements, identified and resolved 7 issues}
...
\resumeItem{Managed flow of the game to ensure customer enjoyment and safety}
\resumeItemListEnd
